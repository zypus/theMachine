...
public class IntruderSpawnSystem
	...
	private void spawnIntruder() {
		...
		newAgent.add(new BehaviourComponent<AntColonyBehaviour.AntColonyBehaviourState>().setBehaviour(new AntColonyBehaviour()).setState(new AntColonyBehaviour.AntColonyBehaviourState(0, 0, AntColonyBehaviour.AgentType.INTRUDER, 0, newAgent)));
