	...
	public void handleEvent(Event event) {
		if (event instanceof MapEditorSaveEvent) {
			...
			if (doubleTap && !control && !makeAgent) {
				...
				newAgent.add(new BehaviourComponent<AntColonyBehaviour.AntColonyBehaviourState>().setBehaviour(new AntColonyBehaviour()).setState(new AntColonyBehaviour.AntColonyBehaviourState(0, 0, AntColonyBehaviour.AgentType.GUARD)));
